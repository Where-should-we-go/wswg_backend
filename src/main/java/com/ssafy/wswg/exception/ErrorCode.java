...
public enum ErrorCode {
    ...
    INVALID_AI_RECOMMENDATION_REQUEST(40010, HttpStatus.BAD_REQUEST, "AI 여행지 추천 요청 값을 확인해 주세요."),
    ...
    AI_TRIP_CANDIDATE_FAILED(50205, HttpStatus.BAD_GATEWAY, "AI 여행 후보 생성에 실패했습니다.");
